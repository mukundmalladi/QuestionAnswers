...
<div id= 'mainContent'>
<br>
&nbsp You are Here :<h2 style="margin-top: -20px; margin-left: 105px;">Groceries</h2>
...
if (!$link)
  ...
  $db = mysql_select_db('');
	...
	$qry ='select questions.question,questions.qid,questions.timeposted as questiontime  from questions where questions.category = \'grocery\' and state = 0 order by questiontime desc';
...
<?php
$qry ='select questions.question,questions.qid,questions.timeposted as questiontime  from questions where questions.category = \'grocery\' and state = 0 and questions.views > 5';
