...
if (!$link)
  ...
  $db = mysql_select_db('');
	...
	$qry ='select questions.question,questions.qid,questions.timeposted as questiontime  from questions where questions.category = \'general\' and state = 0 order by questiontime desc';
...
<?php
$qry ='select questions.question,questions.qid,questions.timeposted as questiontime  from questions where questions.category = \'general\' and state = 0 and questions.views > 5';
