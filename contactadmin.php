...
<div id= 'mainContent'>
<br>
&nbsp You are Here :<h2 style="margin-top: -20px; margin-left: 105px;">ContactForms</h2>
<div id ='leftcontent'>
...
<tr>
<td>1</td><td>Please Respond by copying the email id with </td>
</tr>
</table>
...
$qry ='select * from contactus';
	...
	if($result)
	{
		...
		$count =1;
			echo "<th>Serial No</th><th>Fullname</th><th>Subject</th><th>Message</th>";
			while($member =mysql_fetch_array($result))
			{
				echo "<tr>";
				echo "<td style=\"font-size: 15px;\"> ";echo $count ;echo "</td>";echo "<td>";echo  $member['Fullname'] ;echo "</td>";	echo "<td>";echo $member['Subject'];echo "</td>";echo "<td>"; echo $member['Message'];echo "</td>";	
				$count++;
				echo "</tr>";
			 //$count++;
			}
