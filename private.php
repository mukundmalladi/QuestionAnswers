...
<div id= 'mainContent'>
<br>
&nbsp You are Here :<h2 style="margin-top: -20px; margin-left: 105px;">Private Question/Answer</h2>
<div id ='leftcontent'>
...
$qry ='select question,questions.timeposted as questiontime,qid as questionid from questions where state=1';
	
	echo "<form name=\"delete\" method=\"post\" onsubmit= \"return myFunction()\" action =\"delete-exec.php?public=0\">";
